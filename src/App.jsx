    ...
    <section id="home" className="bg-gradient-to-r from-gray-800 to-gray-900 text-white py-12 md:py-20">
      <div className="container mx-auto px-4 flex flex-col items-center text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full max-w-3xl">
          <div className="bg-red-600 max-w-[90%] w-full mx-auto text-white px-4 py-3 rounded-lg font-bold text-sm md:text-base sm:max-w-full">10+ Years Experience</div>
          <div className="bg-red-600 max-w-[90%] w-full mx-auto text-white px-4 py-3 rounded-lg font-bold text-sm md:text-base sm:max-w-full">500+ Satisfied Customers</div>
          <div className="bg-red-600 max-w-[90%] w-full mx-auto text-white px-4 py-3 rounded-lg font-bold text-sm md:text-base sm:max-w-full">10+ Premium Products</div>
        </div>
